...
<template>
  <!-- Layout -->
  <div
    class="h-screen max-w-5xl px-2 py-3 mx-auto mt-32 tracking-wide md:px-4 md:mt-44"
  >
    <!-- Title -->
    ...
    <!-- Accordion -->
    <div
      class="grid gap-3 py-8 text-lg leading-6 text-gray-800 md:gap-8 md:grid-cols-2"
    >
      <div class="space-y-3">
        <!-- 1 -->
        <div
