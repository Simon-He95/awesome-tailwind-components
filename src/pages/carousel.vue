...
const urls = import.meta.glob('../components/carousel/*.vue')
...
<template>
  ...
  <div class="grid gap-8 mt-8 md:grid-cols-2 lg:grid-cols-3 p-8">
    ...
    >
      ...
      />
      <span
        class="group-hover:block hidden absolute bottom-0 z-50 left-[50%] text-center truncate -translate-x-[50%] translate-y-[130%] text-gray-500/40 w-full"
